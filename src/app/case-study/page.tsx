...
function Study({ title, children }: { title: string; children: React.ReactNode }) { return <section className="mt-16 grid grid-cols-[minmax(15rem,.6fr)_minmax(0,1.4fr)] gap-8 border-t border-line pt-6 max-[800px]:grid-cols-1"><h2 className={ui.sectionTitle}>{title}</h2><p className="m-0 text-lg text-muted">{children}</p></section>; }
